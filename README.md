...
- 修复长时间对话，生图标签易被AI混淆导致无法生图的问题。
  
#### 1.0.5

- 修复“插入当前消息”模式下，一条回复里包含多个 `<pic prompt="...">` 标签时，后续图片可能无法继续追加的问题。
- 修复生图完成后，点击小箭头无法生成新图的问题。
- 如果你是从旧版本更新，建议在 SillyTavern 的扩展管理里执行更新后刷新页面，确保新版脚本已加载。
